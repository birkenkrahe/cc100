...
* Reading input 2 - w7s16 (02/21/22)
** Objectives
...
** NEXT Understand tangling C code from Org-mode
...
*** PRACTICE
    ...
    * Create an Org-mode file "tangle.org"

    * Add one C code block (use <s [TAB])

    * Add header arguments in the top line:
      - :include <stdio.h>
      - :tangle tangled.c
