...
* Lab session: scanf.org, reading input - w7s18 (02/28/22)
** Objectives
...
** News
   ...
   * [ ] Mid-term grade speech / Improve grade with a project ([[https://github.com/birkenkrahe/org/blob/master/FAQ.org#how-can-i-improve-my-mid-term-grades][FAQ]])
   * [ ] Practice material/notebooks now [[https://drive.google.com/drive/folders/12FZkGSRdzfxFd1-QEMxMkw0Q-Alz4F3U?usp=sharing][in GDrive]] (~reading_input~)
   * [ ] Program assignment *for extra credit*: [[https://github.com/birkenkrahe/cc100/blob/main/practice/dweight_new.pdf][~dweight_new.pdf~]]
...
** Objectives
   ...
   * [ ] Understand how to compile and run C in the shell
   * [ ] Understand literate programming once and for all
   * [ ] Understand what good program layout means (practice)

** Compile and run C in the shell

   * [ ] Create a minimum C file, e.g. a hello world program ~hw.c~-
