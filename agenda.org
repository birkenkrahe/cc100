...
* C constants, naming, layout - w6s15 (02/18/22)
** News
...
** Objectives
   ...
   * [ ] Review: be the compiler / function challenge
   * [ ] Learn more ways of defining C constants
   * [ ] Practice constant definitions
   * [ ] Understand naming conventions for C program
...
** Next week
   ...
   * Review of the volume programming challenge
