...
* NEXT w4s8 (01/31/22)
  ...
  * Lab session: come to class to sort out your Emacs/GCC needs on
    your personal PC, or to understand the solution to last week's
    assignments.

  * See also the [[https://www.youtube.com/playlist?list=PLwgb17bzeNygo8GU6SivwwjsQj9QabqAJ][tutorial video playlist]] that I created, on YouTube.

  * We will continue with learning C on Wednesday at 11 AM.

  * You'll get quiz 3 before the session.
