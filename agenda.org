...
* Boolean algebra, Anti-IF campaign - w11s25 (03/28/22)
** C statements
   ...
   * Though C has many operators, it has few statements: they fall in
     ...
     1) Selection statements: ~if~ and ~switch~ statements allow a
        program to select a particular execution path from a set of
        alternatives.
     ...
     2) Iteration statements: ~while~, ~do~ and ~for~ statements
        support iteration ("looping").

     3) Jump  statements: ~break~,  ~continue~, and  ~goto~ statements
        cause  an  unconditional  jump  to some  other  place  in  the
        program. The ~return~ statement does this, too.

** [[https://francescocirillo.com/products/the-anti-if-campaign][Anti-IF campaign]] (Francesco Cirillo)
   ...
   code, accumulate technical debt and spend more time fixing bugs. In
   the result, the software system become more complex. New features
   and changes will cost more and more." ([[https://francescocirillo.com/products/the-anti-if-campaign][Francesco Cirillo]])
   #+end_quote

** TODO Warming up - quiz 7

   * [ ] Algorithm vs heuristic
     - “When you come to a YIELD sign, you must yield”
     - “To get to the bank, keep going straight”

   * [ ] Pseudocode creation:
     - Which pseudocode represents “stop the car at a stop sign”.

   * [ ] Complete the BPMN model
   ...
   * [ ] What does the statement do?
     #+begin_src C
       int i = 1, j = 2;
       i * j - 1; // what does this statement do?
     #+end_src

** Boolean algebra
* w11s26 (03/30/22)
* Pgm 7 - w11s27 (04/01/22)
