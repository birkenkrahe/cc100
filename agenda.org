...
** Programing assignment review
   ...
   * Selected issues:
     - Submitted screenshot of Org-mode file without output
     - Org-mode meta data not correct (file will still run)
       #+begin_example
       #+AUTHOR: name
   ...
   * A couple of programs looked awfully similar (down to errors):
     ...
     - If in doubt about cheating, check this syllabus section.

   * You can find examples and solutions in the class notes.
     
** Programming assignment (until Monday, 28-Feb, 11 AM)
   ...
   * This time, submit the C source code file (you can write it in
     Org-mode and then tangle it, or just submit the C file as it is).
