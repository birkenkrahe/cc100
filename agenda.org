...
* Booleans, operator precedence, compound if else - w11s25 (03/28/22)
** Term plan

   The plan for the rest of the term:

   * week 11 - ~switch~ and ~break~ statements, random numbers
   ...
   * Includes some do-it-yourself reading (covered in weekly quiz 7-11)

   * Weekly programming assignments 8-13 (submit C or Org versions)
...
*** Selection statements
    ...
    * What is the output in this code?
...
* NEXT switch, case, break, random numbers - w11s26 (03/30/22)
* NEXT Review Pgm 7, pgm 8,  - w11s27 (04/01/22)
