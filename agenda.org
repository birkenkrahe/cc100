...
** Compile and run C in the shell
   ...
   * Three shells[fn:4] are at your disposal: Microsoft shell (MacOS
...
* Formatting I/O
  ...
  * Interactive notebook to code along (GDrive)
...
[fn:4]In other Operating Systems but Windows, there is a fourth shell,
