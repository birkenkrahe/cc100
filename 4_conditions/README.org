...
* README
  ...
  #+begin_quote
  Note on the Org file: if you read this file on GitHub, names to the
  code blocks will not work as links in the GitHub version.
  #+end_quote
...
** Practice
   ...
   * [X] Create a simple BPMN based on the battle [[problem]].
